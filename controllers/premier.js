import { deleteCustomerById, deleteInvoicelineById, deleteInvoicesById, deleteItemById, deleteServicesById, deleteVendorPayById, deleteVendorsById, getCustomerById, getCustomers, getinvlineById, getInvoiceLine, 
    ...
    updateVendorsById, getInvoiceSummaryReport, getInvoiceLineServiceReport,
    markAsPickedById,
    updateUserBy,
...
export const showInvoiceSummaryReport = (req, res) => {
    getInvoiceSummaryReport(req.params.date1, req.params.date2, (err, results) => {
        if (err){
            res.send(err);
        }else{
            res.json(results);
...
export const showInvoiceLineServiceReport = (req, res) => {
    getInvoiceLineServiceReport(req.params.date1, req.params.date2, (err, results) => {
        if (err){
            res.send(err);
        }else{
            res.json(results);
